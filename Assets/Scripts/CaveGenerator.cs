...
public class CaveGenerator : MonoBehaviour
{
    ...
    private void GenerateCaves()
    {
        ...
        MonoCavePart previousPart = null;
        ...
        for (int i = 0; i < initialCaveParts; i++)
        {
            ...
            if (i == 0)
            {
                firstCavePart = caveInstance.GetComponent<MonoCavePart>();
                previousPart = firstCavePart;
            }
            else
            {
                previousPart.nextPart = caveInstance.GetComponent<MonoCavePart>();
